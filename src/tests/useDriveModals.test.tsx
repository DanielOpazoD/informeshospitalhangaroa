...
describe('useDriveModals', () => {
    it('solicita inicio de sesión al abrir guardado sin autenticación', () => {
        ...
        const { result } = renderHook(() => useDriveModals({
            ...
            dispatchRecordCommand: vi.fn().mockReturnValue({ ok: true, record: { version: 'v14', templateId: '2', title: '', patientFields: [], sections: [], medico: '', especialidad: '' }, warnings: [], changed: true }),
