...
export interface DriveGatewayImpl {
...
export const buildSearchQuery = ({ searchTerm, dateFrom, dateTo }: DriveSearchFilters): string => {
...
export const createDriveGatewayImpl = (): DriveGatewayImpl => {
